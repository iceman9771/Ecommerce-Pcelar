  ...
  productForm.submit(function(event){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          if (data.added){
            submitSpan.html("<button type='submit' class='btn btn-danger'>Remove?  <i class=\"fa fa-minus-circle\" aria-hidden=\"true\"></i></button>")
          } else {
            submitSpan.html("<button type='submit'  class='btn btn-success'>Add to cart <i class=\"fa fa-cart-plus\" aria-hidden=\"true\"></i></button>")
           }
